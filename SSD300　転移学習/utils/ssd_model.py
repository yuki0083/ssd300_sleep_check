...
def make_datapath_list(rootpath):
    ...
    """
    path_to_train_data = 'train_anotation\\sleeping_check-PascalVOC-export\\'
    ...
    """
    path_to_val_data = 'val_anotation\\sleep_check-PascalVOC-export\\'
    ...
    def __call__(self, xml_path, width, height):
        ...
        for obj in xml.iter('object'):
            ...
            for pt in (pts):
                ...
                cur_pixel = int(float(bbox.find(pt).text)) - 1      #数字の文字列を直接int型にはできなにのでいったんfloatに変換
